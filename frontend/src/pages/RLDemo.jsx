...
function simulateNextWeek(student) {
  const riskChange =
    student.gru.riskScore > 0.6
      ? -0.18
      : student.gru.riskScore > 0.3
      ? -0.12
      : -0.05;
  ...
  const newRiskScore = Math.max(
    ...
    Math.min(
      0.95,
      student.gru.riskScore + riskChange + (Math.random() * 0.1 - 0.05)
    )
  );
  const newEngagementScore = Math.max(
    0.5,
    Math.min(3.0, student.engagementScore + (Math.random() > 0.4 ? 0.2 : -0.1))
  );
  ...
  return {
    ...
    gru: {
      ...
      riskLevel:
        newRiskScore > 0.6 ? "HIGH" : newRiskScore > 0.3 ? "MEDIUM" : "LOW",
      reconstructionError: Math.max(
        0.01,
        student.gru.reconstructionError - 0.003
      ),
      history: [...student.gru.history.slice(1), student.gru.riskScore],
    },
    engagementScore: newEngagementScore,
    engagementHistory: [
      ...student.engagementHistory.slice(1),
...
function decideRL(riskLevel, engagement, previousAction) {
  ...
  if (riskLevel === "HIGH" && engagement < 1.6) return "EMAIL_REMINDER";
  if (riskLevel === "MEDIUM" && engagement > 1.8) return "MOTIVATIONAL_MESSAGE";
  if (riskLevel === "LOW") return "DO_NOTHING";
  ...
  const addNewWeek = () => {
    ...
    setTimeout(() => {
      const updatedStudent = {
        ...
        previousActions: [
          ...selectedStudent.previousActions.slice(1),
          rlAction,
        ],
      };
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-4 md:p-6">
      <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            ...
            <div className="bg-white rounded-xl p-4 shadow-md">
              ...
              <div className="text-2xl font-bold text-emerald-600">
                {(
                  students.reduce((acc, s) => acc + s.engagementScore, 0) /
                  students.length
                ).toFixed(1)}
              </div>
            ...
            <div className="bg-white rounded-xl p-4 shadow-md">
              ...
              <div className="text-2xl font-bold text-blue-600">
                {students
                  .filter(
                    (s) =>
                      s.previousAction !== "NONE" &&
                      s.previousAction !== "DO_NOTHING"
                  )
                  .length.toLocaleString()}
              </div>
          ...
          <div className="mb-8 bg-white rounded-xl shadow-lg p-6 animate-fadeIn">
                  ...
                  {batchAnalysisResults.map((result, index) => (
                    ...
                    >
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span
                            className={`text-sm font-medium ${
                              riskLevels[result.currentRisk].text
                            }`}
                          >
                            {result.currentRisk}
                          </span>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span
                          className={`inline-flex items-center gap-1 px-2 py-1 rounded text-xs ${
                            actionDescriptions[result.previousAction]?.color ||
                            "bg-gray-100 text-gray-800"
                          }`}
                        >
                          <span>
                            {actionDescriptions[result.previousAction]?.icon ||
                              "⏸️"}
                          </span>
                          <span>
                            {actionDescriptions[result.previousAction]?.title ||
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        ...
                        >
                          <span>
                            {actionDescriptions[result.newAction].icon}
                          </span>
                          <span>
                            {actionDescriptions[result.newAction].title}
                          </span>
                        </span>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                          ...
                          <div className="w-24 bg-gray-200 rounded-full h-2">
                            <div
                              className={`h-2 rounded-full ${
                                result.engagement > 2.0
                                  ? "bg-emerald-500"
                                  : result.engagement > 1.5
                                  ? "bg-amber-500"
                                  : "bg-red-500"
                              }`}
                              style={{
                                width: `${(result.engagement / 3) * 100}%`,
                              }}
                            />
                          </div>
                        </div>
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              <div className="text-sm text-gray-600">
                <span className="font-medium">Summary:</span> Analyzed{" "}
                {batchAnalysisResults.length} students.
                {
                  batchAnalysisResults.filter(
                    (r) => r.newAction !== "DO_NOTHING"
                  ).length
                }{" "}
              ...
              <div className="mb-4">
                ...
                {searchTerm && (
                  <div className="text-xs text-gray-500 mt-2">
                    Showing {Math.min(filteredStudents.length, 50)} of{" "}
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-3 mt-3">
                      <div
                        className={`h-3 rounded-full ${
                          selectedStudent.gru.riskLevel === "HIGH"
                            ? "bg-red-500"
                            : selectedStudent.gru.riskLevel === "MEDIUM"
                            ? "bg-amber-500"
                            : "bg-emerald-500"
                        }`}
                        style={{
                          width: `${selectedStudent.gru.riskScore * 100}%`,
                        }}
                      />
                    </div>
                  </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div
                        className={`px-3 py-1 rounded-full text-sm ${
                          selectedStudent.gru.reconstructionError < 0.03
                            ? "bg-emerald-100 text-emerald-800"
                            : selectedStudent.gru.reconstructionError < 0.05
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-2 mt-3">
                      <div
                        ...
                        style={{
                          width: `${
                            (1 -
                              selectedStudent.gru.reconstructionError / 0.1) *
                            100
                          }%`,
                        }}
                      />
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-3 mt-3">
                        <div
                          ...
                          style={{
                            width: `${
                              (selectedStudent.engagementScore / 3) * 100
                            }%`,
                          }}
                        />
                      </div>
                      ...
                      <div className="space-y-2">
                        {selectedStudent.previousActions.map((action, idx) => (
                          <div key={idx} className="flex items-center gap-2">
                            <div
                              className={`px-2 py-1 rounded text-xs ${actionDescriptions[action].color}`}
                            >
                              {actionDescriptions[action].icon}
                            </div>
                            <span className="text-sm">
                              {actionDescriptions[action].title}
                            </span>
                ...
                {stage === "RL_DONE" && rlAction && (
                  <div className="space-y-4 animate-fadeIn">
                    <div className="text-center mb-6">
                      ...
                      <div
                        className={`inline-flex items-center gap-3 px-6 py-4 rounded-xl border-2 ${actionDescriptions[rlAction].color} animate-pulse`}
                      >
                        <span className="text-3xl">
                          {actionDescriptions[rlAction].icon}
                        </span>
                    ...
                    <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                      <div className="text-sm text-blue-800">
                        ...
                        {selectedStudent.gru.riskLevel === "HIGH" &&
                        selectedStudent.previousAction === "NONE"
                          ? "High risk with no previous action → Send In-App Reminder"
                          : selectedStudent.gru.riskLevel === "HIGH" &&
                            selectedStudent.engagementScore < 1.6
                          ? "High risk with low engagement → Send Email Reminder"
                          : selectedStudent.gru.riskLevel === "MEDIUM" &&
                            selectedStudent.engagementScore > 1.8
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-xs text-gray-500 truncate">
                        {actionDescriptions[history.action].title} •{" "}
                        {history.timestamp}
                      </div>
                    </div>
                    <div
                ...
                {simulationHistory.length === 0 && (
                  <div className="text-center py-8 text-gray-500">
                    ...
                    <div className="text-sm mt-1">
                      Run RL engine to see interventions
                    </div>
                  </div>
                )}
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-3">
                    <div
                      ...
                      style={{
                        width: `${
                          (students.filter((s) => s.gru.riskLevel === "HIGH")
                            .length /
                            students.length) *
                          100
                        }%`,
                ...
                <div>
                  <div className="flex justify-between text-sm mb-1">
                    ...
                    <span>
                      {students
                        .filter((s) => s.gru.riskLevel === "MEDIUM")
                        .length.toLocaleString()}
                    </span>
                  </div>
                  <div className="w-full bg-gray-200 rounded-full h-3">
                    <div
                      ...
                      style={{
                        width: `${
                          (students.filter((s) => s.gru.riskLevel === "MEDIUM")
                            .length /
                            students.length) *
                          100
                        }%`,
                ...
                <div>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-3">
                    <div
                      ...
                      style={{
                        width: `${
                          (students.filter((s) => s.gru.riskLevel === "LOW")
                            .length /
                            students.length) *
                          100
                        }%`,
                ...
                <div className="text-sm text-gray-600">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="text-xs">
                      Avg Week:{" "}
                      {(
                        students.reduce((acc, s) => acc + s.week, 0) /
                        students.length
                      ).toFixed(0)}
                    </div>
                    <div className="text-xs">
                    ...
                    <div className="text-xs">
                      Active:{" "}
                      {
                        students.filter((s) => s.previousAction !== "NONE")
                          .length
                      }
                    </div>
                    <div className="text-xs">
        ...
        <footer className="mt-8 text-center text-gray-600 text-sm">
          <p>
            Adaptive Learning Intervention System v2.0 • GRU + RL Implementation
          </p>
          <p className="mt-1">
