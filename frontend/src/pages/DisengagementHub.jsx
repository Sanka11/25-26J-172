      ...
      <div className="bg-white border-b border-slate-200 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 py-8">
          ...
          <p className="text-slate-600 ml-14">
            Manage and monitor GRU and RL model operations
          </p>
        </div>
      </div>
                ...
                <div className="relative p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className={`p-3 ${item.bgLight} rounded-lg group-hover:scale-110 transition-transform duration-300`}>
                      <Icon className={`w-6 h-6 text-${item.color.split('-')[1]}-600`} />
                    </div>
                    ...
                    <div className="flex-1">
                      ...
                      {/* Action Button */}
                      <div className={`inline-flex items-center gap-2 text-${item.color.split('-')[1]}-600 font-medium text-sm group-hover:gap-3 transition-all duration-300`}>
