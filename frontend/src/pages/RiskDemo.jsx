...
export default function RiskDemo() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error(err);
      setError("Failed to get risk score. Please try again.");
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-600 max-w-2xl">
            Simulate how AcademiGuard estimates academic risk using GPA,
            attendance and engagement. This is a simple demo model, not
        ...
        <div className="grid gap-6 md:grid-cols-[minmax(0,1.6fr)_minmax(0,1.2fr)] items-start">
          ...
          <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 p-6 space-y-3 text-sm text-slate-700">
            ...
            {score !== null && !error && (
              <div className="rounded-xl bg-blue-50 border border-blue-100 px-4 py-3">
                ...
                <p className="mt-1 text-[11px] text-slate-600">
                  ...
                  for this profile based on the demo model.
                </p>
              </div>
            )}
            ...
            {score === null && !error && (
              <p className="text-[11px] text-slate-500">
                Run a prediction to see how the demo model responds to different
                student profiles.
              </p>
            )}
          </div>
