...
function Layout() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 flex text-slate-900">
      ...
      <div className="flex-1 flex flex-col relative bg-slate-100/90">
        ...
        {!isChatOpen && (
          <button
            ...
            className="fixed bottom-5 right-5 z-40 flex items-center gap-2 rounded-full bg-blue-600 px-4 py-3 text-white shadow-xl shadow-blue-600/30 transition-all duration-300 ease-out hover:bg-blue-700 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-300"
            title="Ask AcademiGuard"
          >
            <svg
              className="h-5 w-5"
              fill="none"
      ...
      {/* Floating chatbot - moved outside flex layout for proper fullscreen */}
      {isChatOpen && (
        <div
          className={`fixed z-50 transition-all duration-300 ease-in-out ${
            isChatMaximized
              ? "top-0 left-0 w-screen h-screen"
              : "bottom-0 right-0 w-screen h-[85vh] sm:bottom-[20px] sm:right-[20px] sm:w-[380px] sm:h-[500px] sm:max-w-[calc(100vw-40px)] sm:max-h-[calc(100vh-40px)]"
          }`}
        >
          <Chat
