...
/* =====================================================
   Route-aware layout wrapper
   - Isolates GRU & RL module pages
   - Preserves existing application layout
   ===================================================== */
function AppLayout() {
  const location = useLocation();

  // Existing state-based navigation (DO NOT CHANGE)
  const [view, setView] = useState("risk");
  const [isChatOpen, setIsChatOpen] = useState(false);

  /* -----------------------------------------------------
     Standalone module routes (GRU + RL)
     ----------------------------------------------------- */
  ...
  return (
    <>
      ...
      <Routes>
        ...
        {/* GRU routes (kept for routing consistency) */}
        <Route path="/gru" element={<GRUMain />} />
        <Route path="/gru/search" element={<SearchRisk />} />
        <Route path="/gru/all" element={<AllRisks />} />
      </Routes>
